...
player_comp = function(x,y) {
 ...
 mat1_sum = player_comp(pheonix, spirit)
...
tallawahs = c("Imad Wasim", "BA King", "FA Allen", "AD Hales", "Mohammad Amir", "Naveen-ul-Haq", "CJ Green", "BCJ Cutting", "J Blackwood", "SSJ Brooks", "HR Walsh", "RA Reifer", "AA Jangoo", "SR Taylor", "SK Springer", "NA Gordon", "KSA McKenzie", "JM James")
