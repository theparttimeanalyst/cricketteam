...
bat_1_sum = results2 %>% select(bowl_5, .pred_Yes) %>%
                                filter(bowl_5 >0)



ggplot(bat_1_sum, aes(x = bowl_5, y = .pred_Yes)) + geom_point()
...
fire = c("GD Phillips", "SS Eskinazi", "TB Abell", "DA Douthwaite", "BGF Green", "RE van der Merwe", "LWP Wells", "DJ Willey", "JM Clarke", "CB Cooke", "DA Payne", "GLS Scrimshaw", "JT Ball", "Haris Rauf", "Shaheen Shah Afridi", "JM Bairstow")
...
bat_sum = mod_sum_bat %>% filter(team %in% c("royals", "kings"))
