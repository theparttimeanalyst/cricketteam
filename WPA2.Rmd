...
bears = c("MM Ali", "AL Davies", "GJ Maxwell", "SR Hain", "CG Benjamin","DR Mousley", "EG Barnard", "DR Briggs", "HJH Brookes", "JB Lintott", "CN Miles")
hamps = c("BR McDermott", "JM Vince", "TJ Prest", "JJ Weatherley", "RA Whiteley","JK Fuller", "TE Albert", "LA Dawson", "NT Ellis", "MS Crane", "CP Wood")
...
match_sum = team_bat(notts,derby, "notts")  %>%
                     bind_rows(team_bat(foxes, durham, "foxes")) %>%
                               bind_rows(team_bat(bears, northam, "bears")) %>%
                            bind_rows(team_bat(york, worces, "york")) %>%
                              bind_rows(team_bat(glamor, essex, "glam")) %>%
                                  bind_rows(team_bat(glouces, somers, "glouc")) %>%
                                    bind_rows(team_bat(kent, hamps, "kent")) %>%
                                        bind_rows(team_bat(sussex, surrey, "sussex"))
...
```{r}
  ...
  ggplot(bat_sum, aes(x = coltit, y = tot_bat_wp, col = team)) + geom_point()
