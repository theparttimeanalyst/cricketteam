...
pheonix = c("Miles Hammond", "WCF Smeed", "DR Mousley", "BM Duckett", "BAC Howell", "MM Ali", "LS Livingstone", "JG Bethell", "Shadab Khan
", "CG Benjamin", "JL Smith","TG Helm", "HJH Brookes", "AF Milne", "KW Richardson", "CR Woakes")
spirit = c("Z Crawley", "DW Lawrence", "DJ Bell-Drummond", "LA Dawson", "RS Bopara", "JA Thompson", "DJ Mitchell", "AM Rossington", "MS Pepper", "MS Wade", "CP Wood", "MA Wood", "NT Ellis", "DJ Worrall", "MS Crane")
...
rocket = c("AD Hales", "DJ Malan", "JE Root", "C Munro", "SR Hain", "SR Patel", "L Gregory", "TJ Moores", "T Kohler-Cadmore", "L Wood", "SJ Cook", "DR Sams", "JA Turner", "BTJ Wheal", "Rashid Khan", "M Carter", "IS Sodhi")
fire = c("GD Phillips", "SS Eskinazi", "TB Abell", "DA Douthwaite", "BGF Green", "RE van der Merwe", "LWP Wells", "DJ Willey", "JM Clarke", "JM Bairstow", "CB Cooke", "DA Payne", "GLS Scrimshaw", "JT Ball", "Haris Rauf", "Shaheen Shah Afridi")
